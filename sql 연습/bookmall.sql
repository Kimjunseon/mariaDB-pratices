...
values(null, '김준선', '010-8888-8888', 'junseon@gmail.com', 'helloworld123!');

insert
  into member(no, member_name, phone_number, member_mail, member_password)
values(null, '김비트', '010-5555-5555', 'bit@gmail.com', 'bit555!');

insert
  into member(no, member_name, phone_number, member_mail, member_password)
values(null, '피카츄', '010-9999-9999', 'pika@gmail.com', 'chu555!');
