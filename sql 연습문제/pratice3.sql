...
select a.emp_no, concat(a.first_name,' ', a.last_name), b.to_date
    from employees a, titles b
   where a.emp_no = b.emp_no
group by a.emp_no
  having b.to_date != '9999-01-01';

-- 문제6.
-- 직원 이름(last_name) 중에서 S(대문자)로 시작하는 직원들의 이름, 부서명, 직책을 조회하세요.
select a.last_name, d.dept_name, b.title, a.last_name, concat(a.first_name,' ', a.last_name)
    from employees a, titles b, dept_emp c, departments d
   where a.emp_no = b.emp_no
     and a.emp_no = c.emp_no
     and d.dept_no = c.dept_no
group by a.emp_no
  having substring(a.last_name, 1,1) = 'S';
